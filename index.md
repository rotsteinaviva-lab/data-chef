  ...
  <tr>
    ...
    <td valign="top" style="padding-left: 25px;">
      ...
      <div style="margin-bottom: 20px;">
        <h3><a href="/blog/first-post" style="color: #24292e; text-decoration: none;">How to Build a Modern Blog Sidebar</a></h3>
        <p style="color: #555;">This guide walks you through building complex side-by-side elements without abandoning your favorite Markdown ecosystem.</p>
      </div>

      <div>
        <h3><a href="/blog/java-tips" style="color: #24292e; text-decoration: none;">Mastering Java Front-Matter Metadata</a></h3>
        <p style="color: #555;">Learn how compilation engines extract arrays from Markdown front-matter fields to build structured navigation menus seamlessly.</p>
      </div>
    </td>
  </tr>
</table>
